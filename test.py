...
# CryptoPlatinum : Easy and reliable handling of SegWit with CryptoSteel
# Copyright (C) 2018  Antoine FERRON
#
#  Generates a SegWit P2SH address from a passphrase
#
...
if __name__ == '__main__':
	...
	mnemonicw = "banquier citoyen conduire espoir horizon jaune mensonge triomphe union usure"
	mnemonicbaselist = mnemonicw.split(" ")
	passphrase = ""
	network = 5
	z = len(wlf)
	for i in xrange(79000,249001):
